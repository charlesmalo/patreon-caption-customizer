/**
 * Background script (MV3, Firefox event page).
 * -------------------------------------------
 ...
 *      custom sites the user has already granted host access to. Curated sites
 *      are handled by the static manifest matches.
 *
 * `chrome.scripting.registerContentScripts` may be unavailable on older Firefox
 * releases; every dynamic call is wrapped so the extension degrades gracefully.
 */
'use strict';
